...
1. Entender contexto com `opensdd sdd context FEAT-0009`.
2. Confirmar plano e tarefas técnicas.
3. Implementar com rastreabilidade no changelog.
4. Declarar impacto de frontend (obrigatorio) com `opensdd sdd frontend-impact FEAT-0009 ...`.
...
- [MEM] Consolidar memoria com `opensdd sdd finalize --ref FEAT-0009`
