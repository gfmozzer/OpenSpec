...
3. Rode `opensdd sdd start FEAT-0001` para abrir a execucao.
4. Rode `opensdd sdd context FEAT-0001` antes de implementar.
5. Declare impacto de frontend com `opensdd sdd frontend-impact FEAT-0001 --status required|none --reason "..."`.
6. Rode `opensdd sdd finalize --ref FEAT-0001` ao consolidar a feature.
