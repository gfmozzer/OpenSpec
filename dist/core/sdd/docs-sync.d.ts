...
export declare function syncSddGuideDocs(projectRoot: string, paths: SddPaths): Promise<{
...
export declare function validateSddGuideDocs(projectRoot: string, paths: SddPaths): Promise<{
